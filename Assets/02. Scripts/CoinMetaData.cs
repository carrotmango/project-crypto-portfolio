...
public static class CoinMetaDatabase {
    public static readonly CoinMetaData[] AllCoins = new CoinMetaData[] {
        ...
        new("사인", "SIGN", 110.0, 115000000, CoinTheme.ZK, 4, "분산형 메시징 중심의 소셜 플랫폼", ""),
        new("솔라나", "SOL", 130000.0, 115000000, CoinTheme.Layer1, 3, "고성능 Layer1, 빠른 처리속도 자랑", ""),
        new("트럼프", "TRUMP", 8000.0, 115000000, CoinTheme.Meme, 5, "정치적 이슈에 따라 변동", "",fournanceListed: true),
        new("에이브", "AAVE", 180000.0, 115000000, CoinTheme.DeFi, 3, "탈중앙 금융 대출 플랫폼", ""),
        new("톤", "TON", 2000.0, 115000000, CoinTheme.Layer1, 3, "텔레그램 기반 소셜 생태계", ""),
        new("애니메코인", "ANIME", 80.0, 115000000, CoinTheme.Meme, 4, "애니메이션 및 서브컬쳐 NFT 유틸리티", ""),
        new("무브먼트", "MOVE", 578.5, 115000000, CoinTheme.Meme, 5, "실생활 활동 연계 + 게임 보상", ""),
        ...
        new("유에스디티", "USDT", 1350.0, 1000000000, CoinTheme.Stable, 1, "달러 가치에 고정된 스테이블 코인", "", bullbitListed: true),
        new("유에스디씨", "USDC", 1350.0, 1000000000, CoinTheme.Stable, 1, "투명한 담보 기반의 스테이블 코인", "", bullbitListed: true),
